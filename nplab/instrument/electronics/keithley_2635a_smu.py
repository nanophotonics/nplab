...
from nplab.instrument import VisaInstrument
import numpy as np


class Keithley2635A(VisaInstrument):
    def __init__(self, address='GPIB0::26', settings={}):
        super(Keithley2635A, self).__init__(address, read_termination='\n',
                                            write_termination='\n', **settings)
        self.reset()
    ...
    def get_src_voltage(self):
        return self.instr.query('print(smua.source.levelv)')
    ...
    def get_src_current(self):
        return self.instr.query('print(smua.source.leveli)')
    ...
    def get_src_voltage_range(self):
        return self.instr.query('print(smua.source.rangev)')
    ...
    def get_src_current_range(self):
        return self.instr.query('print(smua.source.rangei)')
    ...
    def get_meas_voltage_range(self):
        return self.instr.query('print(smua.measure.rangev)')
    ...
    def get_meas_current_range(self):
        return self.instr.query('print(smua.measure.rangei)')
    ...
    def get_src_compliance(self):
        return self.instr.query('print(smua.source.compliance)')
    ...
    def get_src_voltage_limit(self):
        return self.instr.query('print(smua.source.limitv)')
    ...
    def get_src_current_limit(self):
        return self.instr.query('print(smua.source.limiti)')
    def set_src_current_limit(self, limit):
        self.instr.write('smua.source.limiti=%s' % limit)
    src_current_limit = property(set_src_current_limit, get_src_current_limit)
    ...
    def measure_iv(self, autoscale=True):
        current, voltage = self.get_meas_iv()
        if autoscale:
