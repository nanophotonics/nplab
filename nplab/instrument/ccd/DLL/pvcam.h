...
#ifndef _PVCAM_H
#define _PVCAM_H
static const char *_pvcam_h_="$Header: /PVCAM V2.6/SourceCommon/pvcam.h   26   2013-03-14 16:37:14-04:00   skatsumata $";
...
#define PARAM_SENSOR_TYPE           ((CLASS2<<16) + (TYPE_INT32<<24)     + 270)
...
#define PARAM_UNIFIED_GAIN_ENABLED  ((CLASS2<<16) + (TYPE_BOOLEAN<<24)   + 357)
/* Unified gain for PI-Max4.                                                 */
#define PARAM_UNIFIED_GAIN          ((CLASS2<<16) + (TYPE_INT32<<24)     + 358)
...
#define PARAM_TTL_LINES             ((CLASS2<<16) + (TYPE_INT32<<24)     +  91)
#define PARAM_TTL_DIR_CTRL          ((CLASS2<<16) + (TYPE_INT32<<24)     + 355)


        /* Special Features */

#define PARAM_DITHERING             ((CLASS2<<16) + (TYPE_BOOLEAN<<24)   + 359)
...
/* used with the PARAM_EXPOSURE_MODE parameter id.                            
  ...
  -----------------------------------------------------------------------------------------
   ...
   TRIGGER_FIRST_MODE: CTRL_TRIG_FIRST  CTRL_KINETICS_SINGLE                    CTRL_IEC
