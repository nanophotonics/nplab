...
def single_position_fit(spectra,calibration_wavelengths):
	'''
...
def scan_fit(dataset,debug = 0):
	...
	for (center_wavelength,spectra,calibration_wavelengths) in dataset:
		...
		gradient, offset = single_position_fit(spectra,calibration_wavelengths)
