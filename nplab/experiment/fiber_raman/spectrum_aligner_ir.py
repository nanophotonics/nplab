...
def single_position_fit(spectra,
...
def scan_fit(dataset, debug=0):
    ...
    for (center_wavelength, spectra, calibration_wavelengths) in dataset:
        ...
        if len(spectra) > 1:
            ...
            print(center_wavelength, len(spectra),
                  len(calibration_wavelengths))
            gradient, offset = single_position_fit(
                spectra,
                calibration_wavelengths,
                debug=debug,
