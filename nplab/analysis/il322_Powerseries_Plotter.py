...
from nplab.analysis import il322_NPoM_DF_Powerseries_Plotter as il322 
#from nplab.analysis.SERS_Fitting import Iterative_Raman_Fitting as irf

#%%

wn_cal_633nm = np.loadtxt(r'S:\il322\PhD Data\M-TAPP-SMe\2023-03-17_M-TAPP-SMe_60nm-NPoM\2023-03-35_Calibrated_Wavenumbers_633nm.txt')
laser_powers = np.loadtxt(r'S:\il322\PhD Data\M-TAPP-SMe\2023-03-17_M-TAPP-SMe_60nm-NPoM\2023-03-35_Laser_Powers_633nm.txt')
R_setup_633nm = np.loadtxt(r'S:\il322\PhD Data\M-TAPP-SMe\2023-03-17_M-TAPP-SMe_60nm-NPoM\2023-03-35_R_Setup_633nm.txt')
H2_nanocavity = np.loadtxt(r'S:\il322\PhD Data\M-TAPP-SMe\2023-03-17_M-TAPP-SMe_60nm-NPoM\2023-03-35_Processed_H2-TAPP-SMe-60nm_NPoM_Average-Nanocavity-Timescan_633nm.txt', delimiter = ',')
Co_nanocavity = np.loadtxt(r'S:\il322\PhD Data\M-TAPP-SMe\2023-03-17_M-TAPP-SMe_60nm-NPoM\2023-03-35_Processed_Co-TAPP-SMe-60nm_NPoM_Average-Nanocavity-Timescan_633nm.txt', delimiter = ',')
Ni_nanocavity = np.loadtxt(r'S:\il322\PhD Data\M-TAPP-SMe\2023-03-17_M-TAPP-SMe_60nm-NPoM\2023-03-35_Processed_Ni-TAPP-SMe-60nm_NPoM_Average-Nanocavity-Timescan_633nm.txt', delimiter = ',')
Zn_nanocavity = np.loadtxt(r'S:\il322\PhD Data\M-TAPP-SMe\2023-03-17_M-TAPP-SMe_60nm-NPoM\2023-03-35_Processed_Zn-TAPP-SMe-60nm_NPoM_Average-Nanocavity-Timescan_633nm.txt', delimiter = ',')
...
ax2.plot(wn_cal_633nm, il322.normalise(H2_nanocavity[8]), color='black', label = 'H2-TAPP-SMe')
ax2.plot(wn_cal_633nm, il322.normalise(Co_nanocavity[8]), color='blue', label = 'Co-TAPP-SMe')
ax2.plot(wn_cal_633nm, il322.normalise(Ni_nanocavity[8]), color='red', label = 'Ni-TAPP-SMe')
ax2.plot(wn_cal_633nm, il322.normalise(Zn_nanocavity[8]), color='green', label = 'Zn-TAPP-SMe')
ax2.set_ylim(0,1.1)
ax2.legend()
