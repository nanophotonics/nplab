...
<<<<<<< HEAD:nplab/analysis/NPoM_DF_Analysis/Condense_DF_Spectra.py
        else:
            print 'File format not recognised'
            return
=======
            ...
            try:
                ...
                print('File format not recognised')
                return
>>>>>>> e89a1aa30fd6011dcd1ce17565a0e180c4b7984e:nplab/analysis/NPoM_Dark_Field_categorization/Condense_DF_Spectra.py
        ...
        with h5py.File(outputFile, 'a') as opf:
            ...
            if fileType == 'post-2018':
                for dSetName in ipf[allScans[0]]['Particle_0'].keys():
