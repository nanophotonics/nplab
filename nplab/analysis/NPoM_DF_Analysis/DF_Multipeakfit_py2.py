...
<<<<<<< HEAD:nplab/analysis/NPoM_DF_Analysis/DF_Multipeakfit.py
            stderr = [0] * len(stderr)
...
=======
            ...
            print('\t\tStdErrs: %s' % stderr)
            print('\t\tFWHMs: %s nm\n' % fwhm)
>>>>>>> e89a1aa30fd6011dcd1ce17565a0e180c4b7984e:nplab/analysis/NPoM_Dark_Field_categorization/DF_Multipeakfit.py
