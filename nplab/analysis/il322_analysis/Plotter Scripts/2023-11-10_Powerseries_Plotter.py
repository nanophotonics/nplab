...
my_h5 = h5py.File(r"C:\Users\HERA\Desktop\Offline Data\2023-10-30_633nm_Powerseries_20x_MLAgg.h5")
...
dark_powerseries = np.insert(dark_powerseries, np.linspace(2,len(dark_powerseries),10).astype(int), dark_powerseries[0])
for spec in dark_powerseries:
    print(spec.laser_power)
...
for i, spectrum in enumerate(powerseries):
    ...
    if i == 0:
        ...
        spectrum.plot(ax = ax, plot_y = spectrum.y, title = '633nm Powerseries - 500nW Spectra', linewidth = 1, color = color, label = np.round(powerseries[i-1].laser_power * 1000,1))
...
scan_list = ['ParticleScannerScan_1']
avg_powerseries = np.zeros([21, len(spectrum.y)])
...
for particle_scan in scan_list:
    ...
    for particle in particle_list:
        ...
        for i, spectrum in enumerate(powerseries):
            ...
            offset = 0.03
            if i == 0:
                spectrum.plot(ax = ax, plot_y = spectrum.y, title = '633nm Powerseries - 500nW Spectra - 20x MLAgg', linewidth = 1, color = color, label = 0.0)
                avg_powerseries[i] += (spectrum.y)
            elif spectrum.laser_power < 0.0006:
                spectrum.plot(ax = ax, plot_y = spectrum.y + (i*offset), title = '633nm Powerseries - 500nW Spectra - 20x MLAgg', linewidth = 1, color = color, label = np.round(powerseries[i-1].laser_power * 1000,1))
                avg_powerseries[i] += (spectrum.y)
        ...
        # save_dir = r'C:\Users\HERA\Desktop\Offline Data\2023-10-21_MLAgg\20x\Min Power\_'
        # plt.savefig(save_dir + particle_name + '.svg', format = 'svg')
        # plt.close(fig)
        print(particle_name)
...
for i in range(0, len(avg_powerseries)):
    ...
    if i == 0:
        ...
        ax.plot(x, avg_powerseries[i] + (i*offset), linewidth = 1, color = color, label = np.round(powerseries[i-1].laser_power * 1000, 1))
    ...
    for particle in particle_list:
        ...
        for i, spectrum in enumerate(powerseries):
            ...
            if i == 0:
                ...
                spectrum.plot(ax = ax, plot_y = spectrum.y_norm + (i*offset), title = '633nm Powerseries - 500nW Spectra - 20x MLAgg', linewidth = 1, color = color, label = np.round(powerseries[i-1].laser_power * 1000,1))
                avg_powerseries[i] += (spectrum.y_norm)
        ...
        save_dir = r'C:\Users\HERA\Desktop\Offline Data\2023-10-21_MLAgg\20x\Min Power Normalized\_'
        plt.savefig(save_dir + particle_name + '.svg', format = 'svg')
        plt.close(fig)
        print(particle_name)
...
#%% Plot normalized min power spectrum powerseries avg across MLAgg spots
    ...
    for particle in particle_list:
        ...
        for i, spectrum in enumerate(powerseries):
            ...
            if i == 0:
                ...
                spectrum.plot(ax = ax, plot_y = spectrum.y_norm + (i*offset), title = '633nm Powerseries - 20x MLAgg', linewidth = 1, color = color, label = np.round(spectrum.laser_power * 1000,1))
                avg_powerseries[i] += (spectrum.y_norm)
        ...
        save_dir = r'C:\Users\HERA\Desktop\Offline Data\2023-10-21_MLAgg\20x\Direct Powerseries Normalized\_'
        plt.savefig(save_dir + particle_name + '.svg', format = 'svg')
        plt.close(fig)
        print(particle_name)
...
#%% Plot powerseries avg across MLAgg spots
...
for i in range(0, len(avg_powerseries)):
    ...
    if i == 0:
        ...
        ax.plot(x, avg_powerseries[i] + (i*offset), linewidth = 1, color = color, label = np.round(powerseries[i].laser_power * 1000,1))
...
for line in ax.get_legend().get_lines():
    line.set_linewidth(4.0)
fig.suptitle('633nm Powerseries - 20x MLAgg Average')
ax.set_xlim(250, 1900)
ax.set_ylim(0, 2.2)
plt.tight_layout(pad = 0.8)
