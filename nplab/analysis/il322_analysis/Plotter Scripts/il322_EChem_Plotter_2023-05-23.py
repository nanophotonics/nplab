...
timescan = SERS.SERS_Timescan(h5_MLAgg['Co-TAPP-SMe_60nm_MLAgg_on_Au_1']['633nm_CA-0to-1.0V_20cycles_0.1sx800scans'], name = 'MLAgg')
...
timescan.plot_timescan(t_min = 0, t_max = 20, t_offset=-1, v_max = 200000, plot_echem = True, plot_type='cmap', avg_chunks = 20)
...
timescan.plot_timescan(t_min = 100, t_max = 200, plot_echem = True, plot_type='stack')
