...
def get_directory(particle_name):
    ...
    directory_path = r'C:\Users\il322\Desktop\Offline Data\2023-12-19 Analysis\_' + particle_name + '\\'
...
for i, spectrum in enumerate(powerseries):
    ...
    ## Baseline
    spectrum.baseline = spt.baseline_als(spectrum.y, 1e4, 1e-3, niter = 10)
